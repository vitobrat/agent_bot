...
menu_keyboard_list = [
    [
        types.InlineKeyboardButton(
            text="Показать все статьи", callback_data="show_page_article_all"
        )
    ],
    [
        types.InlineKeyboardButton(
            text="Показать сегодняшние статьи", callback_data="show_page_article_today"
        )
    ],
    [
        types.InlineKeyboardButton(
            text="Очистить контекст беседы", callback_data="clear_history"
        )
    ],
    [types.InlineKeyboardButton(text="О проекте", callback_data="about_project")],
    [
        types.InlineKeyboardButton(
            text="Контакты разработчика", callback_data="contacts"
        )
    ],
]
...
next_prev_page_all_list = [
    [
        types.InlineKeyboardButton(
            text="Назад", callback_data="show_page_article_all_inline_btn_prev"
        ),
        types.InlineKeyboardButton(
            text="Вперед", callback_data="show_page_article_all_inline_btn_next"
        ),
    ]
]
...
next_prev_page_today_list = [
    [
        types.InlineKeyboardButton(
            text="Назад", callback_data="show_page_article_today_inline_btn_prev"
        ),
        types.InlineKeyboardButton(
            text="Вперед", callback_data="show_page_article_today_inline_btn_next"
        ),
    ]
]
next_prev_page_today = types.InlineKeyboardMarkup(
    inline_keyboard=next_prev_page_today_list
)
...
admin_keyboard_list = [
    ...
    [
        types.InlineKeyboardButton(
            text="Новостное уведомление", callback_data="admin_newsletter"
        )
    ],
    [
        types.InlineKeyboardButton(
            text="Спарсить сегодняшние статьи", callback_data="admin_parse_articles"
        )
    ],
]
...
back_admin_keyboard = types.InlineKeyboardMarkup(
    inline_keyboard=back_admin_keyboard_list
)
